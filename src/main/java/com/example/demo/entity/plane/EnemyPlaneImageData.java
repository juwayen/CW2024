...
public class EnemyPlaneImageData extends PlaneImageData {
    private static final String MOVING_STRAIGHT_1_IMAGE_NAME = "enemy_plane_moving_straight_1.png";
    private static final String MOVING_STRAIGHT_2_IMAGE_NAME = "enemy_plane_moving_straight_2.png";
    private static final String MOVING_RIGHT_1_IMAGE_NAME = "enemy_plane_moving_right_1.png";
    private static final String MOVING_RIGHT_2_IMAGE_NAME = "enemy_plane_moving_right_2.png";
    private static final String MOVING_LEFT_1_IMAGE_NAME = "enemy_plane_moving_left_1.png";
    private static final String MOVING_LEFT_2_IMAGE_NAME = "enemy_plane_moving_left_2.png";
