...
public class BossWingLeftData extends PlaneData {
    ...
    private static final String DESTROYED_1_IMAGE_NAME = "boss_plane_wing_left_destroyed_1.png";
    private static final String DESTROYED_2_IMAGE_NAME = "boss_plane_wing_left_destroyed_2.png";
    private static final String DESTROYED_3_IMAGE_NAME = "boss_plane_wing_left_destroyed_3.png";
    private static final String DESTROYED_4_IMAGE_NAME = "boss_plane_wing_left_destroyed_4.png";
    private static final String DESTROYED_5_IMAGE_NAME = "boss_plane_wing_left_destroyed_5.png";
    private static final String DESTROYED_6_IMAGE_NAME = "boss_plane_wing_left_destroyed_6.png";
    private static final String DESTROYED_7_IMAGE_NAME = "boss_plane_wing_left_destroyed_7.png";
    private static final String DESTROYED_8_IMAGE_NAME = "boss_plane_wing_left_destroyed_8.png";
    private static final String DESTROYED_9_IMAGE_NAME = "boss_plane_wing_left_destroyed_9.png";
